...
def rbf(x_1, x_2, sigma=1.):
    ...
    '''
    sq_dist = torch.cdist(x_1, x_2, p=2).pow(2)

    # Compute the RBF kernel
    distances = torch.exp(-sq_dist / (2 * sigma ** 2)) ### YOUR CODE HERE
...
def hinge_loss(scores, labels):
    ...
    losses = torch.clamp(1 - labels * scores, min=0)
    return losses.mean()
...
class SVM(BaseEstimator, ClassifierMixin):
    ...
    def linear(x_1, x_2):
        ...
        '''
        return torch.mm(x_1, x_2.T) ### YOUR CODE HERE
